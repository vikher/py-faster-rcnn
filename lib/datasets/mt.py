...
class mt(imdb):
    def __init__(self, image_set, devkit_path):
        ...
        self._classes = ('__background__', # always index 0
                         'sku1003','sku10041','sku1004','sku10062','sku1006','sku10071','sku10072','sku1007','sku1009','sku1016','sku101811','sku1018','sku102302','sku1036','sku10411','sku10412','sku1045','sku112103','sku112106','sku112108','sku112109','sku112112','sku112113','sku1121221','sku112123','sku232323232','sku815011','sku815021','sku815041','sku81507','sku815081','sku81508','sku815231','sku82202','sku92403','sku92409')
	...
	boxes = np.zeros((num_objs, 4), dtype=np.uint16)
        ...
        for ix, obj in enumerate(objs):
            ...
            #x2 = float(coor[2])
            #y2 = float(coor[3])
            x2 = float(get_data_from_tag(obj, 'xmin')) 
            y2 = float(get_data_from_tag(obj, 'ymin')) 
            x1 = float(get_data_from_tag(obj, 'xmax'))
            y1 = float(get_data_from_tag(obj, 'ymax'))
